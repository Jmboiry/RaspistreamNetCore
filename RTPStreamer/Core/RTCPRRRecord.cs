...
{
	public class RTCPRRRecord
	{
		public uint SenderSSRC { get; set; }
		public uint LossStats { get; set; }
		public uint HighestReceived { get; set; }
		public uint Jitter { get; set; }
		public uint TimeLastSR { get; set; }
		public uint TimeSinceLastSR { get; set; }
	}
}
