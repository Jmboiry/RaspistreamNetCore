...
{
	public class RTPSessionState
	{
		public bool TCP { get; set; }
		public INetworkTransport RTPTransport { get; set; }
		public INetworkTransport RTCPTransport { get; set; }
		public IPEndPoint RTPIPEndPoint { get; set; }
		public IPEndPoint RTCPIPEndPoint { get; set; }
		public uint OctetCount { get; set; }
		public uint PacketsCount { get; set; }
